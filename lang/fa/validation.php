...
return [
    ...
    */
    ...
    'date_equals' => ':attribute باید با تاریخ :date مطابق باشد.',
    ...
    'no_temp_mail' => 'امکان ثبت‌نام با استفاده از ایمیل‌های موقت وجود ندارد.',
    ...
    'not_same' => ':attribute و :other نباید همانند هم باشند.',
    ...
    'unique' => ':attribute مورد نظر قبلا انتخاب شده است.',
    'uploaded' => 'بارگذاری فایل :attribute موفق نبود.',
    'url' => ':attribute معتبر نمی‌باشد.',
    'uuid' => ':attribute باید یک UUID معتبر باشد.',
    'hashids' => ':attribute انتخاب شده معتبر نیست.',
    'expired' => ':attribute مورد نظر منقضی شده است.',
    'recaptcha' => 'لطفاً ثابت کنید که شما ربات نیستید.',
